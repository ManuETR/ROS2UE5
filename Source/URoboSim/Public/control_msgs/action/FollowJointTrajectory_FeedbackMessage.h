...
namespace control_msgs
{
	namespace action {
		...
		class FollowJointTrajectory_FeedbackMessage : public FROSBridgeMsg
		{
		...
		public:
			...
			{
				MsgType = "control_msgs/action/FollowJointTrajectory_FeedbackMessage";
			}
			...
			~FollowJointTrajectory_FeedbackMessage() override {}
			...
			static FollowJointTrajectory_FeedbackMessage GetFromJson(TSharedPtr<FJsonObject> JsonObject)
			{
				FollowJointTrajectory_FeedbackMessage Result;
